...
with open('C:\\Users\\DELL\\OneDrive\\Desktop\\final year project\\random_forest_model.pkl', 'rb') as f:
    model = pickle.load(f)

with open('C:\\Users\\DELL\\OneDrive\\Desktop\\final year project\\tfidf_vectorizer (2).pkl', 'rb') as f:
